...
export const executionFilterConfig: ExecutionFilterConfig = {
  ...
  rulesBySymbol: {
    ...
    // Crypto — relaxed for 24/7 OB trading
    BTCUSD: {
      symbol: 'BTCUSD',
      enabled: true,
      allowedDirections: ['buy', 'sell'],
      ...
      requireBosInDirection: false,
      requireLiquiditySweep: false,
      requireDisplacementCandle: false,
      enabledSessions: [
        { label: '24/7', startHour: 0, endHour: 23 },
      ],
      ...
      maxConcurrentTradesPerSymbol: 2,
      maxConcurrentTradesPerDirection: 1,
      maxDailyRiskPerSymbol: 200,
      maxSpreadPips: 50,
      minDistanceFromDailyHighLowPips: 0,
      minConfluenceScore: 0,
      displacementMinATRMultiplier: 0,
    },
    ETHUSD: {
      symbol: 'ETHUSD',
      enabled: true,
